/**
 * Script para deploy do predixv1 na testnet Stacks
 *
 * Uso: ORACLE_MNEMONIC="..." node scripts/deploy-predixv1.mjs
 */
...
if (!MNEMONIC) {
  ...
  console.error('Usage: ORACLE_MNEMONIC="..." node scripts/deploy-predixv1.mjs')
  process.exit(1)
}

const CONTRACT_NAME = 'predixv1'
const CONTRACT_PATH = './contracts/predixv1.clar'
...
async function main() {
  console.log('Deploying predixv1 to Stacks testnet...\n')
