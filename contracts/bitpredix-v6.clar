;; ============================================================================
;; BITPREDIX v6 - Prediction Market (Beta/Testnet)
;; ============================================================================
;; Mudancas vs v5:
;; - Permite multiplas apostas por usuario por round (UP e DOWN)
;; - Key do map bets agora inclui side: { round-id, user, side }
;; - Apostas no mesmo lado acumulam valor
;; - Claim por side (claim-round-side)
;; ============================================================================
